...
const EmployeeWelcomeGrid: React.FC = () => {
	...
	const [tableData, setTableData] = useState<EmployeeDataType | undefined>(undefined);
					...
					<Row gutter={[16, 8]} className="employee-row-card">
						{tableData?.teamLeader && (
							<Col className="employee-col-card" >
								<Card className="card-employee" style={{ backgroundColor: "#474CCC" }}>
						...
						<Col>
							<Card className="card-employee" style={{ backgroundColor: "#CA054D" }}>
						...
						<Col>
							<Card className="card-employee" style={{ backgroundColor: "#136F63" }}>
					...
					<Row style={{ justifyContent: "space-between" }}>
						<Col>
							<Card className="card-promotions" style={{ marginTop: "20px" }}>
								...
								<img style={{ width: "168px", height: "168px" }} src={Promotions} />
							...
							<Card className="card-quote" styles={{ body: { height: "auto" } }}>
								<Flex style={{ display: "flex", alignItems: "center" }}>
									<div>
										...
										<p style={{ fontWeight: "lighter", fontSize: "17px" }}>"{quote}"</p>
										<p style={{ fontWeight: "lighter", float: "right" }}>- {author}</p>
									</div>
									<div>
										<img style={{ width: "178px", height: "184px" }} src={Qoute} />
									</div>
								</Flex>
							</Card>
						</Col>
