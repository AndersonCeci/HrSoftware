...
const styleTypes = {
  annual: {
    background:
      "linear-gradient(135deg, #447fff, #447fff, #2a9be6, #2a9be6, #30d3cb)",
    backgroundColor: "#2a9be6",
  },
  sick: {
    background:
      "linear-gradient(135deg, #f269c3, #f576d1, #f882de, #fb8ef1, #fc95f4)",
    backgroundColor: "#f576d1",
  },
  other: {
    background:
      "linear-gradient(135deg, #ff512f, #ff6a3d, #ff834b, #ff9c59, #ffa567)",
    backgroundColor: "#ff6a3d",
  },
};

export const applyCategoryColor = (
