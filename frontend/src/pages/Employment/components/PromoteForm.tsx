...
const PromoteForm = forwardRef(({ selectedEmployee, onEdit }: PromotionFormProps, ref) => {
	...
	return (
		<div>
			...
			>
				<FormInputs.Select label={t("position")} name="position" options={position} />
				<FormInputs.Input label="Salary" name="salary" defaultValidateRule="number" required />
