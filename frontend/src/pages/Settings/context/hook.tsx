...
export const usePasswordValidation = (form: any) => {
  const validateConfirmPassword = (_rule: Rule, value: any, callback: (error?: string) => void) => {
  ...
  const validateNewPasswordNotOldPassword = (_rule: Rule, value: any, callback: (error?: string) => void) => {
