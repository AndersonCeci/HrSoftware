...
export class MailService {
  ...
  try {
    const result = await this.mailerservice.sendMail({
        ...
        context:{
            ...
            name: dto.name,
             ...
             hr:dto.hr,
             imageUrl: "https://firebasestorage.googleapis.com/v0/b/hrsoftware-75457.appspot.com/o/loginlogo.png?alt=media&token=22a63636-b29c-4ac6-a0b9-2ab66880564b"
        },
         text:dto.text,
    ...
    if (error.response) {
        const errorMessage = error.response.body ? error.response.body : 'An unknown error occurred';
